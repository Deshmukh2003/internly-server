...
import com.internly.service.InternshipService;
...
public class InternshipController {
  ...
  public Page<InternshipResponse> browse(
    ...
    return internships.browse(search, domain, location, pageable);
  }

  @GetMapping("/{id}")
  public InternshipResponse detail(@PathVariable Long id) {
    return internships.getActive(id);
  }
}
