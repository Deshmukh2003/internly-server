...
import com.internly.service.AuthService;
...
public class AuthController {
  ...
  private final com.internly.service.PasswordResetService passwordReset;

  public AuthController(
    AuthService auth,
    com.internly.service.PasswordResetService passwordReset
  ) {
    this.auth = auth;
  ...
  public void resetPassword(@Valid @RequestBody ResetPasswordRequest request) {
    passwordReset.reset(request.email(), request.code(), request.newPassword());
  }
