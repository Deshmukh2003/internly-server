  ...
  extends JpaRepository<Application, Long>
{
  ...
  Page<Application> findForStudent(
    @Param("studentId") Long studentId,
    Pageable pageable
  );

  @Query(
    "select a from Application a join fetch a.student s join fetch a.internship i join fetch i.company order by a.appliedAt desc"
  )
  Page<Application> findForAdmin(Pageable pageable);
}
