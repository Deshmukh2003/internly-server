...
public final class InternshipDtos {
  ...
  public record InternshipRequest(
    ...
    List<@NotBlank String> eligibleBranches,
    @Size(max = 120) String location,
    @Size(max = 60) String workMode,
    @Min(1) @Max(104) Integer durationWeeks,
    @PositiveOrZero Integer stipend,
    @Future LocalDate applicationDeadline,
    @NotEmpty List<@NotBlank @Size(max = 80) String> requiredSkills,
